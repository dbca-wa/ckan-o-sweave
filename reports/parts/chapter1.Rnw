...
%-------------------------------------------------------------------------------
% Asset Update Elasmobranchs (Sharks, Skates and Rays)
%
<<echo=FALSE>>=
chapter_slug <- "ch01"
...
reviewed <- ""
edited <- ""
i <- ckan_res("431cb74e-79b9-4e49-a87a-bb61e8d28d87")
@
...
\assrow{\Sexpr{report_slug}}{\Sexpr{chapter_title}}{\Sexpr{mpa_period}}{+}{0}{+}{0}{+}
\asspost
...
%
% End Asset Update \Sexpr{report_slug}-\Sexpr{chapter_slug}
%-------------------------------------------------------------------------------
