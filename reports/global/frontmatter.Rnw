...
\href{https://bitbucket.org/dpaw/ckan-o-sweave}{CKAN--o--Sweave} by
...
The source of this report is under \href{https://bitbucket.org/dpaw/mpa-reporting/overview}{version control}.
To author content, contact \href{mailto:Florian.Mayer@dpaw.wa.gov.au}{Florian Mayer}.
The latest working versions are available in the
\href{http://internal-data.dpaw.wa.gov.au/dataset/mpa-reports}{internal DPaW data catalog};
the production process is documented on the
\href{http://data-demo.dpaw.wa.gov.au/dataset/report-automation}{public DPaW data catalog}.
\vspace{1cm}
...
\noindent Copyright \copyright \Sexpr{mpa_year} \Sexpr{mpa_mmu_msp}\\ % Copyright notice
\noindent \textsc{Published by \Sexpr{mpa_mmu_msp}}\\ % Publisher
%\noindent \textsc{book-website.com}\\ % URL

\begin{remark}
For authors and contributors to this report: Please read \nameref{sec:report-structure}
(p.(\pageref{sec:report-structure})) for an explanation of the report's structure,
and see \nameref{sec:report-workflow} (p.(\pageref{sec:report-workflow})) and
\nameref{sec:report-manual} (p.(\pageref{sec:report-manual})) for an in-depth technical
...
%----------------------------------------------------------------------------------------
<<echo=FALSE>>=
i <- ckan_res("5be7ebcd-42e3-46f4-8baa-e04a59b23041")
@
